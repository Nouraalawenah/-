...
// الحصول على معلومات الصورة قبل الحذف
...
if ($delete_stmt->execute()) {
    ...
    echo json_encode(['success' => true, 'message' => __('service_deleted_successfully')]);
} else {
    echo json_encode(['success' => false, 'message' => __('error_deleting_service') . ': ' . $delete_stmt->error]);
}
?>